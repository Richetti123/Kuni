...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} KuniBot
  ${tradutor.texto1[2]} +5492216764542
  ${tradutor.texto1[3]} https://www.instagram.com/kun10.ff
  ...
  const Message = {
    document: { url: `https://www.instagram.com/kun10.ff` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://www.instagram.com/kun10.ff",
        mediaType: 2,
        previewType: "pdf",
        title: "KuniBot",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://www.instagram.com/kun10.ff",
      },
    },
    caption: info,
    footer: wm,
